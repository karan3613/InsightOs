...
class SystemMonitor(QWidget):
    def __init__(self):
        ...
        refresh_process_btn = QPushButton("Refresh Process List")
        refresh_process_btn.setStyleSheet("background-color: #3e3e5e; color: #fff; padding: 6px; border-radius: 5px;")
        refresh_process_btn.clicked.connect(self.show_top_processes)
        ...
        refresh_gaming_btn = QPushButton("Refresh Gaming Stats")
        refresh_gaming_btn.setStyleSheet("background-color: #3e3e5e; color: #fff; padding: 6px; border-radius: 5px;")
        refresh_gaming_btn.clicked.connect(self.show_gaming_stats)
        gaming_layout.addWidget(refresh_gaming_btn)
        ...
        refresh_gpu_btn = QPushButton("Refresh GPU Stats")
        refresh_gpu_btn.setStyleSheet("background-color: #3e3e5e; color: #fff; padding: 6px; border-radius: 5px;")
        refresh_gpu_btn.clicked.connect(self.show_gpu_stats)
        ...
        refresh_btn.setStyleSheet("background-color: #3e3e5e; color: #fff; padding: 6px; border-radius: 5px;")
        refresh_btn.clicked.connect(self.show_specs)
        spec_layout.addWidget(refresh_btn)
